...
componentWillMount(){
  var data=IndiaHacksContract.getKYC()
  this.setState(
    {
...
<center>      <table style={{marginTop:80}}>
        <thead>
           ...
           <th><span style={{marginLeft:30,fontSize:25}}>Number</span></th>
              ...
              <th><span style={{marginLeft:30,fontSize:25}}>Name</span></th>

              <th><span style={{marginLeft:30,fontSize:25}}>SSN</span></th>

              <th><span style={{marginLeft:30,fontSize:25}}>Unique Id</span></th>
              </tr>
        </thead>
        <tbody>
          {TableRows}
